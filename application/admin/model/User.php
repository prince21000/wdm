...
class User extends Model
{
    ...
    public function getIsStudentList()
    {
        return ['1' => __('Is_student 1'), '2' => __('Is_student 2')];
    }
    ...
    {
        return $this->belongsTo('Factions', 'factions_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }
...
//    {
//        return $this->belongsTo('app\admin\model\oms\charging\Station', 'station_id', 'id', [], 'LEFT')->setEagerlyType(0);
//    }
