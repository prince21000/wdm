<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"/www/wwwroot/xcx.wdmnb.com/public/../application/admin/view/exam/question/edit.html";i:1681295370;s:69:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/layout/default.html";i:1671020444;s:66:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/common/meta.html";i:1671020444;s:68:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/common/script.html";i:1671020444;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<!--            <input id="c-top_category_id" data-rule="required" min="0" data-source="top/category/index" class="form-control selectpage" name="row[top_category_id]" type="text" value="<?php echo htmlentities($row['top_category_id']); ?>">-->
<!--        </div>-->
<!--    </div>-->
<!--    <div class="form-group">-->
<!--        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Second_category_id'); ?>:</label>-->
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-second_category_id" data-rule="required" min="0" data-source="second/category/index" class="form-control selectpage" name="row[second_category_id]" type="text" value="<?php echo htmlentities($row['second_category_id']); ?>">-->
<!--        </div>-->
<!--    </div>-->
<!--    <div class="form-group">-->
<!--        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Third_category_id'); ?>:</label>-->
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-third_category_id" data-rule="required" min="0" data-source="third/category/index" class="form-control selectpage" name="row[third_category_id]" type="text" value="<?php echo htmlentities($row['third_category_id']); ?>">-->
<!--        </div>-->
<!--    </div>-->
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <select id="c-category_id" data-rule="required" class="form-control selectpicker" name="row[category_id]">
                ...
                <option data-type="<?php echo $vo['exam_type_id']; ?>" value="<?php echo $key; ?>" value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['third_category_id'])?$row['third_category_id']:explode(',',$row['third_category_id']))): ?>selected<?php endif; if($vo['level']!=3): ?>disabled<?php endif; ?>><?php echo $vo['name']; ?>
                </option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8" id="fieldlist-box">
            <table class="table fieldlist" data-template="basictpl" data-name="row[option]" id="option-table" data-tag="tr">
                ...
                <textarea name="row[option]" id="option-content" class="form-control hidden" cols="30" rows="5"><?php echo htmlentities($row['option']); ?></textarea>
            </table>
            ...
            <script id="basictpl" type="text/html">
                <tr class="form-inline">
                    ...
                    <td>
                        <input type="hidden" name="<%=name%>[<%=index%>][is_answer]" id="c-is_answer-<%=index%>" class="form-control option-state" style="width:50px" value="<%=row.is_answer%>" placeholder="是否答案"/>
                        <a href="javascript:;" data-toggle="switcher" class="btn-switcher" data-input-id="c-is_answer-<%=index%>" data-yes="1" data-no="0" >
                            <i class="fa fa-toggle-on text-success <%if(row.is_answer==0){%>fa-flip-horizontal text-gray<%}%> fa-2x"></i>
                        </a>
                    </td>
                    <td>
                        <!--下面的两个按钮务必保留-->
...
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-right_option" class="form-control" name="row[right_option]" type="text" value="<?php echo htmlentities($row['right_option']); ?>" readonly>-->
<!--        </div>-->
<!--    </div>-->
<!--    <div class="form-group">-->
<!--        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Analysis'); ?>:</label>-->
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <textarea id="c-analysis" class="form-control " rows="5" name="row[analysis]" cols="50"><?php echo htmlentities($row['analysis']); ?></textarea>-->
<!--        </div>-->
<!--    </div>-->
    <div class="form-group">
