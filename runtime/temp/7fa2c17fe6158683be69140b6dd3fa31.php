<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"/www/wwwroot/xcx.wdmnb.com/public/../application/admin/view/user/user/edit.html";i:1682070899;s:69:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/layout/default.html";i:1671020444;s:66:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/common/meta.html";i:1671020444;s:68:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/common/script.html";i:1671020444;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<!--    </div>-->
    <div class="form-group">
        <label for="c-goldcoin" class="control-label col-xs-12 col-sm-2"><?php echo __('Goldcoin'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-goldcoin" data-rule="required" class="form-control" name="row[goldcoin]" type="number" value="<?php echo $row['goldcoin']; ?>" disabled>
        </div>
    </div>
<!--    <div class="form-group">-->
...
<!--    </div>-->
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Factions.name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-factions_id" min="0" data-rule="required" data-source="factions/index" class="form-control selectpage" name="row[factions_id]" type="text" value="<?php echo htmlentities($row['factions_id']); ?>" disabled>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Examtype.name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-exam_type_id" min="0" data-rule="required" data-source="exam/type/index" class="form-control selectpage" name="row[exam_type_id]" type="text" value="<?php echo htmlentities($row['exam_type_id']); ?>" disabled>
        </div>
    </div>
    <div class="form-group">
        <label for="c-school" class="control-label col-xs-12 col-sm-2"><?php echo __('School'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-school" data-rule="required" class="form-control" name="row[school]" type="text" value="<?php echo htmlentities($row['school']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-major" class="control-label col-xs-12 col-sm-2"><?php echo __('Major'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-major" data-rule="required" class="form-control" name="row[major]" type="text" value="<?php echo htmlentities($row['major']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="c-exam_time" class="control-label col-xs-12 col-sm-2"><?php echo __('Exam_time'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-exam_time" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[exam_time]" type="text" value="<?php echo datetime($row['exam_time']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-total_answer_num" class="control-label col-xs-12 col-sm-2"><?php echo __('Total_answer_num'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-total_answer_num" data-rule="required" class="form-control" name="row[total_answer_num]" type="number" value="<?php echo htmlentities($row['total_answer_num']); ?>" disabled>
        </div>
    </div>
    <div class="form-group">
        <label for="c-wrong_answer_num" class="control-label col-xs-12 col-sm-2"><?php echo __('Wrong_answer_num'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-wrong_answer_num" data-rule="required" class="form-control" name="row[wrong_answer_num]" type="number" value="<?php echo htmlentities($row['wrong_answer_num']); ?>" disabled>
        </div>
    </div>
    <div class="form-group">
        <label for="c-accuracy" class="control-label col-xs-12 col-sm-2"><?php echo __('Accuracy'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-accuracy" data-rule="required" class="form-control" name="row[accuracy]" type="number" value="<?php echo htmlentities($row['accuracy']); ?>" disabled>
        </div>
    </div>
    <div class="form-group">
        <label for="c-answer_time" class="control-label col-xs-12 col-sm-2"><?php echo __('Answer_time'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-answer_time" data-rule="required" class="form-control" name="row[answer_time]" type="number" value="<?php echo htmlentities($row['answer_time']); ?>" disabled>
        </div>
    </div>
    <div class="form-group">
        <label for="c-clock_days" class="control-label col-xs-12 col-sm-2"><?php echo __('Clock_days'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-clock_days" data-rule="required" class="form-control" name="row[clock_days]" type="number" value="<?php echo htmlentities($row['clock_days']); ?>" disabled>
        </div>
    </div>
    <div class="form-group">
        <label for="c-is_student" class="control-label col-xs-12 col-sm-2"><?php echo __('Is_student'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[is_student]', ['1'=>__('Is_student 1'), '2'=>__('Is_student 2')], $row['is_student']); ?>
        </div>
    </div>
    <div class="form-group">
        <label for="c-is_student" class="control-label col-xs-12 col-sm-2"><?php echo __('Is_top'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[is_top]', ['1'=>__('Is_top 1'), '2'=>__('Is_top 2')], $row['is_top']); ?>
        </div>
    </div>
    <div class="form-group">
        <label for="c-jointime" class="control-label col-xs-12 col-sm-2"><?php echo __('Jointime'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-jointime" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[jointime]" type="text" value="<?php echo datetime($row['jointime']); ?>" disabled>
        </div>
    </div>
    <div class="form-group">
