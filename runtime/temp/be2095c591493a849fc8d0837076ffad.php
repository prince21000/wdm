<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"/www/wwwroot/xcx.wdmnb.com/public/../application/admin/view/school/school/edit.html";i:1682580146;s:69:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/layout/default.html";i:1671020444;s:66:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/common/meta.html";i:1671020444;s:68:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/common/script.html";i:1671020444;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<!--            <input id="c-province_id" data-rule="required" min="0" data-source="province/index" class="form-control selectpage" name="row[province_id]" type="text" value="<?php echo htmlentities($row['province_id']); ?>">-->
            <div class="" data-toggle="cxselect" data-selects="province">
                <select id="c-province_id" class="province form-control" name="row[province_id]" data-url="ajax/area">
                    <option value="<?php echo htmlentities($row['province_id']); ?>" selected=""></option>
                </select>
            </div>
        </div>
    </div>
