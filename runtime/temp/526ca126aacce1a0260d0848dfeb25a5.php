<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"/www/wwwroot/xcx.wdmnb.com/public/../application/admin/view/schoolhistorymuseum/edit.html";i:1681281580;s:69:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/layout/default.html";i:1671020444;s:66:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/common/meta.html";i:1671020444;s:68:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/common/script.html";i:1671020444;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group <?php if($row['type'] == 1): ?>hide<?php endif; ?>" id="video-box">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Video'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-video" class="form-control" size="50" name="row[video]" type="text" value="<?php echo htmlentities($row['video']); ?>">
                <div class="input-group-addon no-border no-padding">
                    <span><button type="button" id="faupload-video" class="btn btn-danger faupload" data-input-id="c-video" data-mimetype="mp4,mp3,avi,flv,wmv" data-multiple="false" data-preview-id="p-video" data-chunking="true" data-maxsize="500M" data-timeout="120000" ><i class="fa fa-upload"></i> <?php echo __('Upload'); ?></button></span>
                </div>
