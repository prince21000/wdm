<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"/www/wwwroot/xcx.wdmnb.com/public/../application/admin/view/user/quiz/edit.html";i:1681700913;s:69:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/layout/default.html";i:1671020444;s:66:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/common/meta.html";i:1671020444;s:68:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/common/script.html";i:1671020444;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-reply_content" class="form-control" rows="5" name="row[reply_content]" cols="50"><?php echo htmlentities($row['reply_content']); ?></textarea>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Reply_time'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-reply_time" min="0" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[reply_time]" type="text" value="<?php echo $row['reply_time']?datetime($row['reply_time']):''; ?>" disabled>
        </div>
    </div>
