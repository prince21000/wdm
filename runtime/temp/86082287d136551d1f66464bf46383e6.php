<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:92:"/www/wwwroot/xcx.wdmnb.com/public/../application/admin/view/exam/question_category/edit.html";i:1679305480;s:69:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/layout/default.html";i:1671020444;s:66:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/common/meta.html";i:1671020444;s:68:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/common/script.html";i:1671020444;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select id="c-exam_type_id" data-rule="required" class="form-control selectpicker" name="row[exam_type_id]" disabled>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select id="c-pid" data-rule="required" class="form-control selectpicker" name="row[pid]" disabled>
                ...
                <option data-level="<?php echo $vo['level']; ?>" data-type="<?php echo $vo['exam_type_id']; ?>" value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['pid'])?$row['pid']:explode(',',$row['pid']))): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
...
<!--    <div class="form-group">-->
<!--        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Exam_type_id'); ?>:</label>-->
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-exam_type_id" data-rule="required" min="0" data-source="exam/type/index" class="form-control selectpage" name="row[exam_type_id]" type="text" value="<?php echo htmlentities($row['exam_type_id']); ?>">-->
<!--        </div>-->
<!--    </div>-->
<!--    <div class="form-group">-->
<!--        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Pid'); ?>:</label>-->
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-pid" data-rule="required" min="0" class="form-control" name="row[pid]" type="number" value="<?php echo htmlentities($row['pid']); ?>">-->
<!--        </div>-->
<!--    </div>-->
    <div class="form-group">
...
<!--    </div>-->
    ...
    <div class="form-group" id="goldcoin-box" style="display: <?php if($row['pid']>0): ?>none<?php endif; ?>">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Goldcoin'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-goldcoin" min="0" class="form-control" name="row[goldcoin]" type="number" value="<?php echo htmlentities($row['goldcoin']); ?>">
        </div>
    </div>
    <div class="form-group" id="accuracy-box" style="display: <?php if($row['pid']>0): ?>none<?php endif; ?>">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Accuracy'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-accuracy" min="0" class="form-control" step="0.01" name="row[accuracy]" type="number" value="<?php echo htmlentities($row['accuracy']); ?>">
        </div>
    </div>
