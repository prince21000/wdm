<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"/www/wwwroot/xcx.wdmnb.com/public/../application/admin/view/school/school/add.html";i:1680918140;s:69:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/layout/default.html";i:1671020444;s:66:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/common/meta.html";i:1671020444;s:68:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/common/script.html";i:1671020444;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<!--            <input id="c-province_id" data-rule="required" min="0" data-source="ajax/area" data-primary-key="value" data-field="name" class="form-control selectpage" name="row[province_id]" type="text" value="">-->

            <div class="" data-toggle="cxselect" data-selects="province">
                <select id="c-province_id" class="province form-control" name="row[province_id]" data-url="ajax/area"></select>
            </div>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-logo" data-rule="required" class="form-control" size="50" name="row[logo]" type="text">
                <div class="input-group-addon no-border no-padding">
                    <span><button type="button" id="faupload-logo" class="btn btn-danger faupload" data-input-id="c-logo" data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp,image/webp" data-multiple="true" data-preview-id="p-logo"><i class="fa fa-upload"></i> <?php echo __('Upload'); ?></button></span>
