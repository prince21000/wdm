<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"/www/wwwroot/xcx.wdmnb.com/public/../application/admin/view/ad/ad/add.html";i:1681295073;s:69:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/layout/default.html";i:1671020444;s:66:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/common/meta.html";i:1671020444;s:68:"/www/wwwroot/xcx.wdmnb.com/application/admin/view/common/script.html";i:1671020444;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-ad_category_id" data-rule="required" min="0" data-source="ad/category/index" class="form-control selectpage" name="row[ad_category_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group hide" id="path-box">
    ...
    <div class="form-group hide" id="detail_id-box">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Detail_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-detail_id" min="0" data-source="school/school/index" class="form-control selectpage" name="row[detail_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group hide" id="exam_type_id-box">
        <label for="c-exam_type_id" class="control-label col-xs-12 col-sm-2"><?php echo __('Exam_type_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <select id="c-exam_type_id" class="form-control selectpicker" name="exam_type_id">
    ...
    <div class="form-group hide" id="detail_id2-box">
        <label for="c-category_id" class="control-label col-xs-12 col-sm-2"><?php echo __('Detail_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <select id="c-category_id" class="form-control selectpicker" name="category_id">
    ...
    <div class="form-group hide" id="content-box">
