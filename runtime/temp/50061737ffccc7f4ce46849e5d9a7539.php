...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-material_type_id" data-rule="required" min="0" data-source="material/type/index" class="form-control selectpage" name="row[material_type_id]" type="text" value="<?php echo htmlentities($row['material_type_id']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Exam_type_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-exam_type_id" data-rule="required" data-source="exam/type/index" class="form-control selectpage" name="row[exam_type_id]" type="text" value="<?php echo htmlentities($row['exam_type_id']); ?>">
        </div>
    </div>
    <div class="form-group">
...
<!--            <input id="c-description" class="form-control" name="row[description]" type="text" value="<?php echo htmlentities($row['description']); ?>">-->
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-purchase_goldcoin" data-rule="required" min="0" class="form-control" name="row[purchase_goldcoin]" type="number" value="<?php echo htmlentities($row['purchase_goldcoin']); ?>">
        </div>
    </div>
    <div class="form-group">
